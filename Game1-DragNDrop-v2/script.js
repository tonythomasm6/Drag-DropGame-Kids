...
const envurl = "https://www.happytooth.ga/wp-content/uploads/2021/09/";
const imageExt = ".jpg";
...
function loadImages() {
  ...
  document.getElementById("happy").src = "https://www.happytooth.ga/wp-content/uploads/2021/08/" + "happyteeth.png";
  document.getElementById("sad").src = "https://www.happytooth.ga/wp-content/uploads/2021/08/" + "sadteeth.png";

  document.getElementById("happyImage").src = "https://www.happytooth.ga/wp-content/uploads/2021/08/" + "happychild.png";
  document.getElementById("sadImage").src = "https://www.happytooth.ga/wp-content/uploads/2021/08/" + "sadchild.png";
}
...
function goBack(){
  window.location.href = "https://www.happytooth.ga/what-should-i-eat/food-suggestion/";
}

/*To check if all boxes has images*/
const submit = function () {
if(jQuery('#image_row_id').find('img').length > 0){
  alert("Please drag and Drop all images to good or bad !!!");
  return ;
}


  let correct_count = 0;
  jQuery(".good-box img").each(function () {
    if (jQuery(this).hasClass("good")) {
      correct_count++;
      this.style.border = "2px solid green";
      jQuery(this).after(" <r>&#x2713;</r>");
    } else {
      jQuery(this).after(" <wr> &#x2717;</wr>");
      this.style.border = "2px solid red";
    }
  });

  jQuery(".bad-box img").each(function () {
  ...
  /*After submission, again submission should not be allowed. Also image should not be draggable*/
